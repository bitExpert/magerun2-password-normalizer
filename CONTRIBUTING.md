...
If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/magerun2-password-normalizer/issues/new).
...
2. Fork the repository (https://github.com/bitExpert/magerun2-password-normalizer)
...
```console
$ git remote add {username} git@github.com:{username}/magerun2-password-normalizer.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/magerun2-password-normalizer.git
